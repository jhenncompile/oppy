...
/**
 * Cliente HTTP hacia la API LoRA de Oppy (serve_oppy_api.py).
 *
 * Misma filosofia que Exa/Firecrawl: si la URL no esta o el servicio cae,
 * devolvemos null y el caller cae a Ollama. Una corrida no se tumba por el
 * cerebro remoto.
 *
